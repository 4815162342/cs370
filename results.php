		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body" id="signupmodal">
					...
					<p>Username:</p>
					<input type="text" class="form-control modalinputs" id="signup-username" placeholder="Enter a new usrname">
					<p>Email:</p>
      ...
      <div id="products" class="row list-group">
        <div class="item	col-xs-4 col-lg-4">
          <div class="thumbnail">
            ...
            <div class="caption">
              <h2 class="group inner list-group-item-heading" id="protest-result"><a href id="protest-detail-link">[PROTEST TITLE]</a></h2>
              <p class="group inner list-group-item-text">MM/DD/YYYY</p>
