    ...
    <div class="row">
      <div class="col-mid-12">
        <div class="input-group" id="adv-search">
          <input type="text" class="form-control" placeholder="Search for Protests" />
          <div class="input-group-btn">
            <button type="button" class="btn btn-primary red searchiconspacing"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
          </div>
          <!-- Sort by button -->
          <div class="btn-group">
